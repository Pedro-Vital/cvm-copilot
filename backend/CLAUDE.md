...
This is the FastAPI service for CVM Copilot. Read [../CLAUDE.md](../CLAUDE.md) first — universal building rules live there. This file adds backend-specific conventions.
...
├── ingest/              # one-off ingestion scripts (Docling PDF → Markdown, chunking, embedding, Supabase writes)
├── tests/
└── pyproject.toml
```
